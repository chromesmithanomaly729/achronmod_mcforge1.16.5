package com.anomaly729.noobiummod;

import com.anomaly729.noobiummod.block.ModBlocks;
...
@Mod(NoobiumMod.MODID)
//public static final string MODID = "examplemod";
public class NoobiumMod
{
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();
    public static final String MODID = "noobiummod";
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("noobiummod", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
